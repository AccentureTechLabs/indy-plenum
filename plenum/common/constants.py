...
PRE_BATCH_CREATED = 11
POST_BATCH_CREATED = 12
PRE_BATCH_REJECTED = 13
...
NODE_HOOKS = [PRE_STATIC_VALIDATION, POST_STATIC_VALIDATION,
              ...
              PRE_REQUEST_COMMIT, POST_REQUEST_COMMIT, PRE_BATCH_CREATED,
              POST_BATCH_CREATED, PRE_BATCH_REJECTED, POST_BATCH_REJECTED]
...
REPLICA_HOOKS = [CREATE_PPR, CREATE_PR, CREATE_CM, CREATE_ORD, RECV_PPR,
                 RECV_PR, RECV_CM, BATCH_CREATED, BATCH_REJECTED]
